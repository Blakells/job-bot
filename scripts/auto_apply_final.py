...
- For "How did you hear": Use saved_answers or "LinkedIn"
- For "Know anyone at Company": "No"
- For "LinkedIn Profile": Use linkedin_url
- For "Legal name"/"Full name": Use name
...
def fill_react_select(page, label, answer):
    """Fill React-Select dropdown - EXACT code from test_dropdown_direct.py"""
    try:
        # Find label element
        ...
        if label_el.count() > 0:
            ...
            if input_id:
                ...
                if autocomplete.count() > 0:
                    ...
                    # Type just the city name
                    city = answer.split(',')[0].strip()
                    autocomplete.type(city, delay=100)
                    time.sleep(1.2)
                    
                    # Click first suggestion
                    first_opt = page.locator("div[class*='option']").first
